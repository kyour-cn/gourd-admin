...
func newUserRole(db *gorm.DB, opts ...gen.DOOption) userRole {
	...
	_userRole.ID = field.NewUint32(tableName, "id")
	_userRole.UserID = field.NewUint32(tableName, "user_id")
	_userRole.RoleID = field.NewUint32(tableName, "role_id")
...
func (a userRoleHasOneRole) Model(m *model.UserRole) *userRoleHasOneRoleTx {
...
func (a userRoleHasOneRoleTx) Find() (result *model.Role, err error) {
	return result, a.tx.Find(&result)
}

func (a userRoleHasOneRoleTx) Append(values ...*model.Role) (err error) {
...
func (a userRoleHasOneRoleTx) Replace(values ...*model.Role) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a userRoleHasOneRoleTx) Delete(values ...*model.Role) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
